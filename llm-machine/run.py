...
def pose_to_prompt(pose_response):
    ...
    return (
        ...
        you need to use the following information about the pose to answer the questions and describe the information:
...
def objects_to_prompt(objects_response):
    ...
    return (
        ...
        you need to use the following information about the objects to answer the questions and describe the information:
...
def ocr_to_prompt(ocr_response):
    
    

# for ocr include information about the position of text and information about objects for the model to combine into understanding text written on objects
